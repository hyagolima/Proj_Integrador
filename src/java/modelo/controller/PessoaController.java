...
import modelo.bean.PessoaFacade;
...
public class PessoaController implements Serializable {
    ...
    @EJB
    private modelo.bean.PessoaFacade ejbFacade;
    ...
    public Pessoa getPessoa(java.lang.String id) {
    ...
    public static class PessoaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Pessoa) {
                ...
                return getStringKey(o.getIdCpf());
            } else {
